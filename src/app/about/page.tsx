...
const Page = () => {
  return (
    <div className="py-20 px-4 max-w-6xl mx-auto">
      <h1 className="text-3xl font-bold mb-4 ">About <span className=" text-blue-600">Nest-Scout</span></h1>
      <p className="mb-4">
        Nest-Scout is a leading real estate agency that specializes in helping
